  ...
  return (
      <CardWrapper>
          <div>
            ...
            <ul className="steps">
                <li className="step step-secondary">Step 1 <br/> Educator Information</li>
                <li className="step step-secondary">Step 2 <br/> School Information</li>
                <li className="step step-secondary">Step 3 <br/> Upload Pictures</li>
                <li className="step">Step 4 <br/> Add Your Story</li>
                <li className="step">Step 5 <br/> Create Supply List</li>
                <li className="step">Step 6 <br/> Review and Complete</li>
            </ul>
